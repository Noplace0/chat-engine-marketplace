...
export const sellers = [
    {
        ...
        custom_json: JSON.stringify({
            ...
            price: "$35",
            description:
                "This book is NOT in very nice condition. But it is very cheap so still worth it :)",
            photos: [
    ...
    },
    {
        ...
        custom_json: JSON.stringify({
            ...
            price: "$45",
            description:
                "This book is in very nice condition. The price is final so nothing to negotiate",
            photos: [
    ...
    },
    {
        ...
        custom_json: JSON.stringify({
            ...
            price: "$55",
            description:
                "This book is in very nice condition. It will help make sure you get the A+ grade you are looking for :)",
            photos: [
    ...
    },
    {
        ...
        custom_json: JSON.stringify({
            ...
            price: "$25",
            description:
                "This book is brand new so the price is final and will be good for the next 4 years before they update it.",
            photos: [
